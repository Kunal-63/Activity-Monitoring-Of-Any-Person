  ...
  Future<void> fetchData() async {
    try {
      final response = await http
          .get(Uri.parse('http://192.168.15.75:5200/number-frequency'));

      final response1 = await http
          .get(Uri.parse('http://192.168.15.75:5200/hashtag-frequency'));

      final response2 = await http
          .get(Uri.parse('http://192.168.15.75:5200/location-frequency'));

      final response3 = await http
          .get(Uri.parse('http://192.168.15.75:5200/profile-picture'));

      final response4 =
          await http.get(Uri.parse('http://192.168.15.75:5200/offensive-bio'));

      final response5 = await http
          .get(Uri.parse('http://192.168.15.75:5200/offensive-comments'));

      final response6 =
          await http.get(Uri.parse('http://192.168.15.75:5200/follower-count'));
